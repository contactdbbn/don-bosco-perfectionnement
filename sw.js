const CACHE = "don-bosco-v115";
const SHELL = ["./", "./index.html", "./styles.css", "./app.js?v=20260915-v115", "./supabase-config.js", "./manifest.json", "./icons/icon-192.png", "./icons/icon-512.png"];
