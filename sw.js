const CACHE = "don-bosco-v120";
const SHELL = ["./", "./index.html", "./styles.css", "./app.js?v=20260915-v120", "./supabase-config.js", "./manifest.json", "./icons/icon-192.png", "./icons/icon-512.png"];
