const CACHE = "don-bosco-v99";
const SHELL = ["./", "./index.html", "./styles.css", "./app.js?v=20260913-v94", "./supabase-config.js", "./manifest.json", "./icons/icon-192.png", "./icons/icon-512.png"];
