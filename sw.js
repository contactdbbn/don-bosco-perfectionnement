const CACHE = "don-bosco-v129";
const SHELL = ["./", "./index.html", "./styles.css", "./app.js?v=20260916-v129", "./supabase-config.js", "./manifest.json", "./icons/icon-192.png", "./icons/icon-512.png"];
