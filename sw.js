const CACHE = "don-bosco-v121";
const SHELL = ["./", "./index.html", "./styles.css", "./app.js?v=20260915-v121", "./supabase-config.js", "./manifest.json", "./icons/icon-192.png", "./icons/icon-512.png"];
