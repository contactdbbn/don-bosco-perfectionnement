const CACHE = "don-bosco-v144";
const SHELL = ["./", "./index.html", "./styles.css", "./app.js?v=20260919-v145", "./supabase-config.js", "./manifest.json", "./icons/icon-192.png", "./icons/icon-512.png"];
