const CACHE = "don-bosco-v81";
const SHELL = ["./", "./index.html", "./styles.css", "./app.js?v=20260911-v81", "./supabase-config.js", "./manifest.json", "./icons/icon-192.png", "./icons/icon-512.png"];
